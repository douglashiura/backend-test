...
import net.douglashiura.crawl.anchor.ExtraUrlProcessorOnlyHtmlAnchor;

public class ExtraUrlProcessorOnlyHtmlAnchorTest {

	private ExtraUrlProcessable processor;

	@BeforeEach
	void setUp() throws MalformedURLException, URISyntaxException {
		processor = new ExtraUrlProcessorOnlyHtmlAnchor(new URL("https://example.com/"), new URL("https://example.com/report/"));
	}
	...
	void distinctAnchors() throws Exception {
		String twoAnchors = " <a href=\"https://example.com/page1.html\">...<a href=\"page.html\">";
		Set<URL> urls = processor.getUrls(twoAnchors);
		assertEquals(2, urls.size());
		assertTrue(urls.contains(new URL("https://example.com/page1.html")));
	...
	@Test
	void xhtmlIgnore() throws Exception {
